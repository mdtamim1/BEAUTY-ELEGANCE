        ...
        ws.on('message', (messageData) => {
            try {
                ...
                if (payload.type === 'message') {
                    ...
                    db.run(`INSERT INTO support_messages (id, customer_id, customer_name, sender, message, read, created_at)
             VALUES (?, ?, ?, ?, ?, 0, ?)`, [id, customerId, customerName, sender, message, timestamp], (err) => {
                        if (err) {
