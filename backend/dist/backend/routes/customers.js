...
import { registerCustomer, loginCustomer, loginGmailCustomer, getCustomerProfile, updateCustomerProfile, getAddresses, addAddress, updateAddress, deleteAddress, setDefaultAddress } from '../controllers/customersController';
import { authenticateToken } from '../middleware/auth';
const router = Router();
// Customer Authentication
router.post('/register', registerCustomer);
router.post('/login', loginCustomer);
router.post('/login-gmail', loginGmailCustomer);
// Customer Profile
