export const seedProducts = [
  ...
  },
  {
    ...
    slug: 'organic-face-serum-collection',
    sku: 'NG-FS-004',
    brand: 'NatureGlow',
    category: 'Beauty',
    price: 45.99,
    ...
    features: [
      '100% Organic',
      'Cruelty-Free',
      'Contains Vitamin C & Hyaluronic Acid'
    ],
    specs: [
  ...
  },
  {
    ...
    slug: '4k-oled-gaming-monitor-32',
    sku: 'VP-M-032',
    brand: 'VisionPro',
    category: 'Electronics',
    price: 699.99,
  ...
  },
  {
    ...
    slug: 'running-shoes-x-carbon-pro',
    sku: 'AS-RS-006',
    brand: 'AeroStep',
    category: 'Sports',
    price: 159.99,
  ...
  },
  {
    ...
    slug: 'premium-silk-pillowcase-set',
    sku: 'SW-SP-008',
    brand: 'SleepWell',
    category: 'Home & Garden',
    price: 59.99,
    ...
    specs: [
      { name: 'Size', value: 'Standard (20" x 26")' },
