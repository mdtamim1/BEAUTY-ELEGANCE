...
export default function Orders() {
  ...
  const [formStoreName, setFormStoreName] = useState('TAMIM GLOBAL');
        ...
        <body>
          <div class="invoice-box">
            ...
            <div class="footer">
              ...
              <span style="font-size: 10px; color: #cbd5e1; margin-top: 5px; display: block;">Generated by Tamim Global</span>
            </div>
          </div>
          <script>
        ...
        <div class="invoice-page">
          <div class="invoice-box">
            <table class="header-table">
              <tr>
                <td>
                  <h1 class="store-name">${order.storeName || 'TAMIM GLOBAL'}</h1>
                  <div style="font-size: 13px; color: #64748b; margin-top: 5px;">Reliable & Premium Shopping</div>
                </td>
                <td>
                  <h2 class="invoice-title">INVOICE</h2>
                  ...
                  <div className="grid-2">
                    <div className="form-group">
                      ...
                      <select value={formStoreName} onChange={(e) => setFormStoreName(e.target.value)} className="form-select" style={{ background: '#111827', border: '1px solid #1e293b', color: '#fff' }}>
                        <option value="TAMIM GLOBAL">TAMIM GLOBAL</option>
