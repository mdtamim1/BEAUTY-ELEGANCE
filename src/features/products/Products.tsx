...
export default function Products() {
  ...
  const handleSaveProduct = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!tempProduct || !tempProduct.name || !tempProduct.sku) return;
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div className="grid-3">
                      <div className="form-group">
                        ...
                        <input type="number" className="form-input" required value={tempProduct.stock ?? ''} onChange={e => setTempProduct({ ...tempProduct, stock: parseInt(e.target.value) || 0 })} placeholder="0" />
                      </div>
                      <div className="form-group">
