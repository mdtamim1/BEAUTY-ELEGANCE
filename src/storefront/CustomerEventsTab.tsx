...
import { Trophy, Sparkles, Flame, Gift, ArrowRight, Zap } from 'lucide-react';
    ...
    <div style={{ padding: '8px 0' }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ margin: '4px 0 0 0', fontSize: '0.85rem', color: 'var(--text-tertiary)' }}>
          আপনার অ্যাকাউন্টের বিশেষ ইভেন্ট ও অফারে অংশগ্রহণ করুন এবং বিশেষ ডিসকাউন্ট পুরস্কার জিতুন!
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '20px' }}>
        ...
        <div
          style={{
            ...
            borderRadius: '20px',
            padding: '24px',
            boxShadow: '0 12px 30px -10px rgba(251, 191, 36, 0.2)',
            position: 'relative',
            overflow: 'hidden',
            display: 'flex',
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            ...
            <span style={{ background: 'rgba(16, 185, 129, 0.15)', color: '#10b981', border: '1px solid rgba(16, 185, 129, 0.4)', padding: '2px 8px', borderRadius: '12px', fontSize: '0.72rem', fontWeight: 700 }}>
              সক্রিয়
            </span>
          </div>
          ...
          <div>
            ...
            <p style={{ margin: '0 0 20px 0', fontSize: '0.88rem', color: '#cbd5e1', lineHeight: 1.5 }}>
              চাকা ঘুরিয়ে পেয়ে যান ২০% পর্যন্ত স্পেশাল ডিসকাউন্ট কুপন ও প্রমো কোড পুরস্কার!
            </p>
          </div>
